...
<head>
  ...
  <style>
    /* notify.js posiciona sus avisos ("top right") pegados al borde superior
       de la ventana por default — en el panel admin eso cae justo detrás/
       encima del navbar fijo (.pf-nav), quedando parcialmente tapado. Se
       empuja explícitamente por debajo del navbar en vez de depender de que
       el z-index alcance (1050 vs 50 — ya debería ganar, pero el reporte
       real era que no se veía completo, así que se resuelve con espacio de
       sobra en vez de solo z-index). */
    .notifyjs-corner { top: 90px !important; }
    @media (max-width: 900px) {
      .notifyjs-corner { top: 140px !important; }
    }
  </style>
</head>
<body class="pf-body">
