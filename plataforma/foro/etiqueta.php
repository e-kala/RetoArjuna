...
$queryBase = array_filter(['slug' => $slug, 'orden' => $orden !== 'recientes' ? $orden : null, 'oculto' => $ocultoFiltro ?: null]);
...
<div class="d-flex flex-wrap align-items-center gap-2 mb-3">
  <?php $ordenCamposOcultos = ['slug' => $slug]; require __DIR__ . '/inc/orden_selector.php'; ?>
